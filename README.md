...
## What's in the app?
A simple go app that displays a [color](https://en.wikipedia.org/wiki/Color) and version. This is designed to work with Argo Rollouts for canary and blue/green progressive delivery. 
